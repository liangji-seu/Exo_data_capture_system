...
XDA_DLL_API XsString* XsDevice_hardwareId(const struct XsDevice* thisPtr, XsString* returnValue);/*!< \copydoc XsDevice::hardwareId() const*/
...
XDA_DLL_API double XsDevice_actualAccelerometerRange(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::actualAccelerometerRange() const*/
XDA_DLL_API double XsDevice_gyroscopeRange(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::gyroscopeRange() const*/
XDA_DLL_API double XsDevice_actualGyroscopeRange(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::actualGyroscopeRange() const*/
...
struct XsDevice {
	...
	{
		XsString returnValue;
		return *XsDevice_hardwareId(this, &returnValue);
	}
	...
	inline double actualAccelerometerRange(void) const
	{
		return XsDevice_actualAccelerometerRange(this);
	}
	...
	inline double actualGyroscopeRange(void) const
	{
		return XsDevice_actualGyroscopeRange(this);
	}
