...
public enum XsResultValue {
  ...
  XRV_BLUETOOTH_SCANNING_ERROR = 500,
  XRV_FLASH_PROCESS_BUSY = 501,
  XRV_FLASH_FULL = 502,
  XRV_INVALID_FLASHFORMAT = 503,
  XRV_SYNC_TOO_FEW_DEVICES = 504,
  XRV_SYNC_COULD_NOT_START = 505,
  XRV_SYNC_SETTINGS_MISMATCH = 506,
  XRV_SYNC_NO_START_ROOT = 507,
  XRV_SYNC_NO_START_SCANNER = 508,
  XRV_SYNC_NO_RECONNECT = 509,
  XRV_SYNC_FAILED = 510,
  XRV_SYNC_ROOT_NOT_FOUND = 511
}
