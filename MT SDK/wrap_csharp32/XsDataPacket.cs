...
public class XsDataPacket : global::System.IDisposable {
  ...
  public XsFloatVector3 rawAccelerationFloat() {
    XsFloatVector3 ret = new XsFloatVector3(xsensdeviceapiPINVOKE.XsDataPacket_rawAccelerationFloat(swigCPtr), true);
    return ret;
  }

  public bool containsRawAccelerationFloat() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsRawAccelerationFloat(swigCPtr);
    return ret;
  }

  public XsFloatVector3 rawGyroscopeDataFloat() {
    XsFloatVector3 ret = new XsFloatVector3(xsensdeviceapiPINVOKE.XsDataPacket_rawGyroscopeDataFloat(swigCPtr), true);
    return ret;
  }

  public bool containsRawGyroscopeDataFloat() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsRawGyroscopeDataFloat(swigCPtr);
    return ret;
  }

  public XsFloatVector3 rawMagneticFieldFloat() {
    XsFloatVector3 ret = new XsFloatVector3(xsensdeviceapiPINVOKE.XsDataPacket_rawMagneticFieldFloat(swigCPtr), true);
    return ret;
  }

  public bool containsRawMagneticFieldFloat() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsRawMagneticFieldFloat(swigCPtr);
    return ret;
  }

  public float rawTemperatureFloat() {
    float ret = xsensdeviceapiPINVOKE.XsDataPacket_rawTemperatureFloat(swigCPtr);
    return ret;
  }

  public bool containsRawTemperatureFloat() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsRawTemperatureFloat(swigCPtr);
    return ret;
  }
  ...
  public XsScrDataFloat rawDataFloat() {
    XsScrDataFloat ret = new XsScrDataFloat(xsensdeviceapiPINVOKE.XsDataPacket_rawDataFloat(swigCPtr), true);
    return ret;
  }

  public bool containsRawDataFloat() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsRawDataFloat(swigCPtr);
    return ret;
  }

  public void setRawDataFloat(XsScrDataFloat data) {
    xsensdeviceapiPINVOKE.XsDataPacket_setRawDataFloat(swigCPtr, XsScrDataFloat.getCPtr(data));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public uint packetCounter32() {
    uint ret = xsensdeviceapiPINVOKE.XsDataPacket_packetCounter32(swigCPtr);
    return ret;
  }

  public bool containsPacketCounter32() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsPacketCounter32(swigCPtr);
    return ret;
  }

  public void setPacketCounter32(uint counter) {
    xsensdeviceapiPINVOKE.XsDataPacket_setPacketCounter32(swigCPtr, counter);
  }
