...
public class XsMessageArray : XsMessageArrayImpl {
  ...
  public XsMessageArray(XsMessage ref_, uint sz, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsMessageArray__SWIG_4(XsMessage.getCPtr(ref_), sz, (int)flags), true) {
  }
