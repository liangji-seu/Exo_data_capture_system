...
public class XsFilterProfileArray : XsFilterProfileArrayImpl {
  ...
  public XsFilterProfileArray(XsFilterProfile ref_, uint sz, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsFilterProfileArray__SWIG_4(XsFilterProfile.getCPtr(ref_), sz, (int)flags), true) {
  }
