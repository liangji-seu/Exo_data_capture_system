...
public class XsString : XsStringImpl {
  ...
  public void toLower() {
    xsensdeviceapiPINVOKE.XsString_toLower(swigCPtr);
  }

  public void toUpper() {
    xsensdeviceapiPINVOKE.XsString_toUpper(swigCPtr);
  }

  public XsString lowered() {
    XsString ret = new XsString(xsensdeviceapiPINVOKE.XsString_lowered(swigCPtr), true);
    return ret;
  }

  public XsString uppered() {
    XsString ret = new XsString(xsensdeviceapiPINVOKE.XsString_uppered(swigCPtr), true);
    return ret;
  }
