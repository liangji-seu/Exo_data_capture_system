...
public class XsByteArrayImpl : global::System.IDisposable {
  ...
  public XsByteArrayImpl(SWIGTYPE_p_unsigned_char ref_, uint sz, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsByteArrayImpl__SWIG_4(SWIGTYPE_p_unsigned_char.getCPtr(ref_), sz, (int)flags), true) {
  }
  ...
  public bool badAlloc() {
    bool ret = xsensdeviceapiPINVOKE.XsByteArrayImpl_badAlloc(swigCPtr);
    return ret;
  }

  public void swap(XsByteArrayImpl other) {
    xsensdeviceapiPINVOKE.XsByteArrayImpl_swap__SWIG_0(swigCPtr, XsByteArrayImpl.getCPtr(other));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }

  public void swap(uint a, uint b) {
    xsensdeviceapiPINVOKE.XsByteArrayImpl_swap__SWIG_1(swigCPtr, a, b);
  }

  public SWIGTYPE_p_ptrdiff_t find(byte needle) {
    SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(xsensdeviceapiPINVOKE.XsByteArrayImpl_find(swigCPtr, needle), true);
    return ret;
  }

  public bool contains(byte needle) {
    bool ret = xsensdeviceapiPINVOKE.XsByteArrayImpl_contains(swigCPtr, needle);
    return ret;
  }
