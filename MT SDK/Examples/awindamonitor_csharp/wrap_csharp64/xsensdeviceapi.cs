...
public class xsensdeviceapi {
  public static bool xorBool(bool a, bool b) {
    bool ret = xsensdeviceapiPINVOKE.xorBool(a, b);
    return ret;
  }
  ...
  public static void findHardwareTypeC(XsDeviceId deviceId, XsString resultValue) {
    xsensdeviceapiPINVOKE.findHardwareTypeC(XsDeviceId.getCPtr(deviceId), XsString.getCPtr(resultValue));
  }

  public static HardwareManufacturerType findHardwareManufacturerC(XsDeviceId deviceId) {
    HardwareManufacturerType ret = (HardwareManufacturerType)xsensdeviceapiPINVOKE.findHardwareManufacturerC(XsDeviceId.getCPtr(deviceId));
    return ret;
  }

  public static double accelerometerRangeC(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.accelerometerRangeC(XsDeviceId.getCPtr(deviceId));
    return ret;
  }

  public static double gyroscopeRangeC(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.gyroscopeRangeC(XsDeviceId.getCPtr(deviceId));
    return ret;
  }

  public static double actualAccelerometerRangeC(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.actualAccelerometerRangeC(XsDeviceId.getCPtr(deviceId));
    return ret;
  }

  public static double actualGyroscopeRangeC(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.actualGyroscopeRangeC(XsDeviceId.getCPtr(deviceId));
    return ret;
  }

  public static XsString findHardwareType(XsDeviceId deviceId) {
    XsString ret = new XsString(xsensdeviceapiPINVOKE.findHardwareType(XsDeviceId.getCPtr(deviceId)), true);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static HardwareManufacturerType findHardwareManufacturer(XsDeviceId deviceId) {
    HardwareManufacturerType ret = (HardwareManufacturerType)xsensdeviceapiPINVOKE.findHardwareManufacturer(XsDeviceId.getCPtr(deviceId));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accelerometerRange(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.accelerometerRange(XsDeviceId.getCPtr(deviceId));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double gyroscopeRange(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.gyroscopeRange(XsDeviceId.getCPtr(deviceId));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double actualAccelerometerRange(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.actualAccelerometerRange(XsDeviceId.getCPtr(deviceId));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double actualGyroscopeRange(XsDeviceId deviceId) {
    double ret = xsensdeviceapiPINVOKE.actualGyroscopeRange(XsDeviceId.getCPtr(deviceId));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static void xdaSetLogger(Journaller journaller) {
    xsensdeviceapiPINVOKE.xdaSetLogger(Journaller.getCPtr(journaller));
  }

  public static Journaller xdaGetLogger() {
    global::System.IntPtr cPtr = xsensdeviceapiPINVOKE.xdaGetLogger();
    Journaller ret = (cPtr == global::System.IntPtr.Zero) ? null : new Journaller(cPtr, false);
    return ret;
  }

  public static void xdaSetAdditionalLogger(AbstractAdditionalLogger logger) {
    xsensdeviceapiPINVOKE.xdaSetAdditionalLogger(AbstractAdditionalLogger.getCPtr(logger));
  }

  public static AbstractAdditionalLogger xdaGetAdditionalLogger() {
    global::System.IntPtr cPtr = xsensdeviceapiPINVOKE.xdaGetAdditionalLogger();
  ...
  public static readonly int XS_DID_BASE_ID_MASK = xsensdeviceapiPINVOKE.XS_DID_BASE_ID_MASK_get();
  public static readonly int XS_DID_EXTENDED_ID_MASK = xsensdeviceapiPINVOKE.XS_DID_EXTENDED_ID_MASK_get();
  ...
  public static readonly int XS_DID_TYPEL_OBSKUR = xsensdeviceapiPINVOKE.XS_DID_TYPEL_OBSKUR_get();
  ...
  public static readonly int XS_DID_GPL_GNSSINSRTK = xsensdeviceapiPINVOKE.XS_DID_GPL_GNSSINSRTK_get();
  ...
  public static readonly int XS_DID_TYPE_MTW2OBSKUR = xsensdeviceapiPINVOKE.XS_DID_TYPE_MTW2OBSKUR_get();
  ...
  public static readonly int JLL_TRACE = xsensdeviceapiPINVOKE.JLL_TRACE_get();
  public static readonly int JLL_DEBUG = xsensdeviceapiPINVOKE.JLL_DEBUG_get();
  public static readonly int JLL_ALERT = xsensdeviceapiPINVOKE.JLL_ALERT_get();
  public static readonly int JLL_ERROR = xsensdeviceapiPINVOKE.JLL_ERROR_get();
  public static readonly int JLL_FATAL = xsensdeviceapiPINVOKE.JLL_FATAL_get();
  public static readonly int JLL_WRITE = xsensdeviceapiPINVOKE.JLL_WRITE_get();
  public static readonly int JLL_DISABLE = xsensdeviceapiPINVOKE.JLL_DISABLE_get();
  public static readonly int JLDEF_BUILD = xsensdeviceapiPINVOKE.JLDEF_BUILD_get();
  public static readonly string JLGENERIC_LINEINFO = xsensdeviceapiPINVOKE.JLGENERIC_LINEINFO_get();
