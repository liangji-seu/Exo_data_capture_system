...
public class XsDeviceIdArray : XsDeviceIdArrayImpl {
  ...
  public XsDeviceIdArray(XsDeviceId ref_, uint sz, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsDeviceIdArray__SWIG_4(XsDeviceId.getCPtr(ref_), sz, (int)flags), true) {
  }
