...
public class XsStringImpl : global::System.IDisposable {
  ...
  public XsStringImpl(ref string ref_, uint sz, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsStringImpl__SWIG_4(ref ref_, sz, (int)flags), true) {
  }
  ...
  public bool badAlloc() {
    bool ret = xsensdeviceapiPINVOKE.XsStringImpl_badAlloc(swigCPtr);
    return ret;
  }

  public void swap(XsStringImpl other) {
    xsensdeviceapiPINVOKE.XsStringImpl_swap__SWIG_0(swigCPtr, XsStringImpl.getCPtr(other));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }

  public void swap(uint a, uint b) {
    xsensdeviceapiPINVOKE.XsStringImpl_swap__SWIG_1(swigCPtr, a, b);
  }

  public SWIGTYPE_p_ptrdiff_t find(char needle) {
    SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(xsensdeviceapiPINVOKE.XsStringImpl_find(swigCPtr, needle), true);
    return ret;
  }

  public bool contains(char needle) {
    bool ret = xsensdeviceapiPINVOKE.XsStringImpl_contains(swigCPtr, needle);
    return ret;
  }
