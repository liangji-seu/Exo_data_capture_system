...
public class XsInt64Array : XsInt64ArrayImpl {
  ...
  public XsInt64Array(SWIGTYPE_p_long_long ref_, uint sz, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsInt64Array__SWIG_4(SWIGTYPE_p_long_long.getCPtr(ref_), sz, (int)flags), true) {
  }
