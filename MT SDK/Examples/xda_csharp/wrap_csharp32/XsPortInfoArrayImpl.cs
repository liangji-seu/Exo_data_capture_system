...
public class XsPortInfoArrayImpl : global::System.IDisposable {
  ...
  public bool badAlloc() {
    bool ret = xsensdeviceapiPINVOKE.XsPortInfoArrayImpl_badAlloc(swigCPtr);
    return ret;
  }
  ...
  public bool contains(XsPortInfo needle) {
    bool ret = xsensdeviceapiPINVOKE.XsPortInfoArrayImpl_contains(swigCPtr, XsPortInfo.getCPtr(needle));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
