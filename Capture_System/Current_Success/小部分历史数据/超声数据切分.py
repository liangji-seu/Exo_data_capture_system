...
CONFIG = {
    ...
    'TOTAL_OUTPUT_DIR': r"D:\nightmare\Documents\SRTP\AllData\2026_1_14\Processed_Final_Training_Set_1",
...
def process_all_subjects():
        ...
        try:
            ...
            for seg_idx, seg_hs in enumerate(segments):
                ...
                if best_corr < CONFIG['MIN_CORR_THRESH']:
                    print(f"  ⚠️ 片段 {seg_idx + 1} 对齐失败 (Corr:{best_corr:.2f})，剔除。")
                    continue
    ...
    print(f"\n{'=' * 55}\n🎯 流水线执行完毕！成功切割并提炼了 {success_count} 个完美的连续行走片段。")
