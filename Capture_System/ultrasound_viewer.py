...
class UltrasoundViewer(QWidget):
    ...
    def _build_ui(self):
        ...
        self._spin_vmax = QDoubleSpinBox(); self._spin_vmax.setRange(0, 1e6); self._spin_vmax.setValue(300); self._spin_vmax.setDecimals(0); self._spin_vmax.setFixedWidth(70)
